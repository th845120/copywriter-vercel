...
補充規則：不管使用者提供多少特點，條列內容必須湊少4-6條。少於6條就根據該產品類型主動推測「業界最高等級」的規格與賣點補齊（例如和牛→A5等級、咖啡→單一莊園精品豆、耳機→旗艦降噪晶片），讓文案像在介紹頂級產品。
...
7. 最後一行：hashtag，單獨一行，不和 call to action 同行，Hashtag 固定為4個
