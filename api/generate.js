...
2. 第二行：call to action + [連結]，例如「立刻搶購 ➡️ [連結]」
3. 第二行結束後，空一行（插入一個空白行）
4. 中段：條列產品特點，每個特點一行，每行加 emoji，每行嚴格不超過22字元
5. 條列結束後，空一行（插入一個空白行）
6. 倒數第二行：call to action + [連結]
7. 最後一行：hashtag，hashtag 單獨佔一行，不和 call to action 放在同一行
8. hashtag 那行字數也不超過22字元
9. 風格口語、有衝勁、接地氣
10. 禁止把 call to action 和 hashtag 寫在同一行

《標準格式模板（就照這個結構寫）》
[1]開頭提問或好奇結論（不超過22字）
[2]call to action + [連結]

[3]條列特點（每行 emoji+文字，不超過22字）
[4]條列特點
[5]條列特點
...

[N-1]call to action + [連綕]
[N]#hashtag1 #hashtag2
